...
test_that("EikonGetTimeseries handles fields = NULL with multiple rics", {
  ...
  result <- EikonGetTimeseries(EikonObject = Eikon,
                               rics = c("MMM", "III.L"),
                               fields = NULL,
...
test_that("EikonGetTimeseries can switch between adjusted and unadjusted", {
  ...
  adjusted <- EikonGetTimeseries(EikonObject = Eikon,
                                 rics = "MMM",
                                 start_date = "2020-01-01T01:00:00",
                                 end_date = "2020-01-10T01:00:00",
                                 corax = "adjusted")
  ...
  unadjusted <- EikonGetTimeseries(EikonObject = Eikon,
                                   rics = "MMM",
                                   start_date = "2020-01-01T01:00:00",
                                   end_date = "2020-01-10T01:00:00",
                                   corax = "unadjusted")
...
dump_refinitiv_options("test-EikonGetTimeSeries")
