...
test_that("rd_GetEstimates errors when package is missing for non-KPI view", {
  ...
  expect_error(
    rd_GetEstimates(RDObject = mock_conn, universe = "AAPL.O",
...
test_that("rd_GetEstimates caches results", {
  ...
  result1 <- rd_GetEstimates(RDObject = mock_conn, universe = "AAPL.O",
                             view = "view-summary/annual", package = "basic",
                             cache = TRUE)
  result2 <- rd_GetEstimates(RDObject = mock_conn, universe = "AAPL.O",
                             view = "view-summary/annual", package = "basic",
                             cache = TRUE)
...
test_that("rd_GetEstimates works with live terminal (summary/annual)", {
  ...
  result <- tryCatch(
    rd_GetEstimates(universe = "AAPL.O",
                    view = "view-summary/annual", package = "basic"),
    error = function(e) {
