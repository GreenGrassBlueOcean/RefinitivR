...
test_that("rd_get_news_headlines returns a flattened data.frame", {
  result <- rd_get_news_headlines(
    RDObject = dummyRD, query = "MSFT.O",
    limit = 2, raw_output = FALSE, debug = FALSE
  )

  # Expected columns as per documentation:
  expected_cols <- c(
    "storyId", "version", "urgency", "firstCreated", "versionCreated",
...
test_that("rd_get_news_headlines returns raw output when raw_output is TRUE", {
  raw_result <- rd_get_news_headlines(
    RDObject = dummyRD, query = "MSFT.O",
      ...
      return(list(
        data = list(
          ...
          list(
            ...
            pages = list(
              list(
                name = "Central Banks & Global Economy", po = "PO1", revisionId = "R1",
          ...
          list(
            ...
            pages = list(
              list(
                name = "U.S. Companies", po = "PO2", revisionId = "R2",
          ...
          list(
            ...
            pages = list(
              list(
                name = "Reuters Breakingviews", po = "PO3", revisionId = "R3",
      ...
      return(list(
        data = list(
          list(
            ...
            pages = list(
              list(
                name = "Front Page", topNewsId = "TN1", po = "PO1", revisionId = "R1",
                revisionDate = "2025-03-12T00:00:00Z"
              ),
              list(
                name = "Alternate Page", topNewsId = "TN1", po = "PO4", revisionId = "R4",
                revisionDate = "2025-03-12T00:00:00Z"
              )
            )
          )
...
dump_refinitiv_options("test-rdGetNewsHeadlines")
