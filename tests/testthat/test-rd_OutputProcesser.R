test_that("rd_OutputProcesser works", {
  response <- list(
    links = list(count = 46L), variability = "", universe = list(
      list(
        Instrument = "GOOG.O", `Company Common Name` = "Alphabet Inc",
        `Organization PermID` = "5030853586", `Reporting Currency` = "USD"
      ),
      list(
        Instrument = "NVDA.O", `Company Common Name` = "NVIDIA Corp",
        `Organization PermID` = "4295914405", `Reporting Currency` = "USD"
      )
    ),
    data = list(
      list("GOOG.O", "2022-10-05T00:00:00", 102.22, 100.69),
    ...
    messages = list(
      ...
      list(
        name = "TR.Close", title = "Price Close", type = "number",
      ...
      list(
        name = "TR.Open", title = "Price Open", type = "number",
  ...
  expected <- structure(
    list(
      Instrument = c(
        ...
        19270, 19271, 19272, 19275, 19276, 19277,
      ...
      TR.Close = c(
        102.22, 102.24, 99.57, 98.71, 98.05, 98.3, 99.71, 97.18, 100.78, 101.39,
      ...
      TR.Open = c(
        100.69, 101.5, 100.65, 99.85, 98.25, 98.27, 95.93, 100.625,
  ...
  expected_2 <- structure(
    list(
      ...
      `Price Open` = c(
        100.69, 101.5, 100.65, 99.85, 98.25, 98.27, 95.93, 100.625, 99.52, 103.94, 100.7, 100.82, 98.46, 102.09,
        103.3, 96.76, 94.31, 92.53, 95.78, 95.59, 90.91, 86.345, 85.51,
        129.107, 132.2, 125.05, 120.37, 115.61, 115.79, 109.71, 120.57,
        115.18, 123.44, 118.79, 121.13, 120.982, 125.08, 126.935, 128.69,
        136.3, 131.04, 137.78, 138.11, 138.5, 130.43, 139.86
...
test_that("rd_OutputProcesser works case RDConnect get_data with names", {
  input <- list(
    columnHeadersCount = 1L, data = list(
      list("MMM", "", "3M Co"),
      list("III.L", 4.23463019323009, "3i Group PLC")
    ), headerOrientation = "horizontal",
    headers = list(list(
      list(displayName = "Instrument"), list(
  ...
  expected <- structure(
    list(
      Instrument = c("MMM", "III.L"),
      `P/E (Daily Time Series Ratio)` = c(NA, 4.23463019323009), `Company Name` = c("3M Co", "3i Group PLC")
    ),
...
test_that("rd_OutputProcesser works case RDConnect get_data with fieldnames", {
  input <- list(
    columnHeadersCount = 1L, data = list(list("MMM", ""), list(
      "III.L", 4.6545003199969
    )), headerOrientation = "horizontal",
  ...
  actual <- rd_OutputProcesser(x = input, use_field_names_in_headers = TRUE)
  ...
  actual <- rd_OutputProcesser(x = input, use_field_names_in_headers = FALSE)
...
test_that("rd_OutputProcesser works case 3 json connect get_data with names", {
  input <- list(
    links = list(count = 3L), variability = "", universe = list(
      list(
        Instrument = "MMM", `Company Common Name` = "3M Co",
        `Organization PermID` = "5000072036", `Reporting Currency` = "USD"
      ),
      list(
        Instrument = "III.L", `Company Common Name` = "3i Group PLC",
        `Organization PermID` = "4295895807", `Reporting Currency` = "GBP"
      )
    ),
    data = list(
      list("MMM", NULL, NULL, "3M Co"), list("III.L", NULL, NULL, "3i Group PLC"),
      list("III.L", "2023-10-20T00:00:00", 4.23463019323009, NULL)
    ),
    messages = list(codes = list(
      list(-1L, -2L, -2L, -1L), list(-1L, -2L, -2L, -1L),
      list(-1L, -1L, -1L, -2L)
    ), descriptions = list(
      list(code = -2L, description = "empty"),
    ...
    headers = list(
      ...
      list(
        name = "TR.PE", title = "P/E (Daily Time Series Ratio)",
      ...
      list(
        name = "Company Name", title = "Company Name", type = "string",
...
test_that("rd_OutputProcesser works case 3 json connect get_data with fields", {
  ...
  actual <- rd_OutputProcesser(input, use_field_names_in_headers = TRUE)


  expected <- structure(
    list(
      Instrument = c("MMM", "III.L", "III.L"),
      Date = structure(c(NA_real_, NA_real_, 19650), class = "Date"),
      TR.PE = c(NA, NA, 4.23463019323009),
      `Company Name` = c("3M Co", "3i Group PLC", NA_character_)
    ),
    row.names = c(NA, -3L), class = c("data.table", "data.frame")
  )
  expect_equal(actual, expected)
...
test_that("rd_OutputProcesser can work with empty and failed requests", {
  # failed request
  x <- list(
    universe = list(ric = "someRic"),
    status = list(
      code = "some error",
      message = "some message"
    )
  )
  suppressMessages(suppressWarnings(expect_equal(
...
test_that("rd_OutputProcesser can work with complete NA responses ", {
  x <- list(
    columnHeadersCount = 1L, data = list(list("NVDA.O", NULL), list("ASMI.AS", NULL)),
    headerOrientation = "horizontal", headers = list(
      list(displayName = NULL),
      list(
        displayName = "TR.IVPRICETOLNTRINSICVALUEGLOBALRANK",
...
test_that("rd_OutputProcesser can work with partial NA responses ", {
  input <- list(
    universe = list(ric = "AAPL.O"), interval = "P1D", summaryTimestampLabel = "endPeriod",
    adjustments = list(
      "exchangeCorrection", "manualCorrection",
      "CCH", "CRE", "RTS", "RPO"
    ), defaultPricingField = "TRDPRC_1",
    headers = list(
      list(name = "DATE", type = "string"), list(
  ...
  test <- rd_OutputProcesser(input, use_field_names_in_headers = TRUE, SpaceConvertor = NULL)
  ...
  CorrectOutcome <- structure(
    list(
      ...
      VWAP = c(
        227.7513, 225.9286, 226.5552, 225.6868,
      ...
      BLKCOUNT = c(
        51, 41, 47, 54, 69, 46, 68, 75, 63, 79, 77, 47, 57, 84, 118,
        99, 133, 122, 102, 76
      ),
      BLKVOLUM = c(
        11416370, 7628281, 11158110,
      ...
      SALTIM = c(
        72000, 72000, 72000, 72900, 72000, 72000, 72000, 72000, 72000, 72000,
      ...
      VWAP_VOL = c(
        28153632, 25868715, 33599651, 33958811, 28963442, 25490741, 35908387,
...
test_that("rd_OutputProcesser can work with full NA responses with one 1 ric", {
  ...
  ReturnValue <- rd_OutputProcesser(
    x = input,
  ...
  Expectedoutcome <- structure(
    list(
      Instrument = "AAPL.O", Date = structure(NA_real_, class = "Date"),
      SETTLE = NA
    ),
...
dump_refinitiv_options("test-rd_OutputProcesser")
