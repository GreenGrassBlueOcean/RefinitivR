...
test_that("TR_field satisfies testcases", {
  ...
  expect_equal(
    TR_Field(Field_name = "TR.GrossProfit", Parameters = list("Scale" = 6, "Curn" = "EUR"), sort_dir = "asc", sort_priority = 0),
...
test_that("EikonRepairMic satisfies testcases", {
  ...
  testdf1 <- data.frame(
    "RDN_EXCHD2" = Refinitiv::OperatingMicLookup$RDN_EXCHD2,
...
test_that("ProcessSymbology satisfies testcases", {
  ...
  Ex3Outcome <- list(list(mappedSymbols = list(list(
    RICs = c(
      "RDSa.AS", "RDSaEUR.xbo",
  ...
  Ex6Outcome <- list(list(mappedSymbols = list(
    list(RICs = c(
      "RDSa.AS", "RDSaEUR.xbo", "RDSaGBP.xbo", "RDSa.L", "RDSa.F", "RDSa.DE", "RDSAl.BS", "RDSAa.CHI",
      "RDSAa.BS", "RDSAl.CHI", "RDSa.BE", "RDSAa.TQ", "RDSAl.TQ", "RDSa.S",
      "RDSa.MU", "RDSa.H", "RDSa.D", "RDSa.SG", "RYDAF.PK", "R6Cd.BS",
      "R6Cd.CHI", "RDSa.HA", "RDSAa.ED", "RDSAl.ED", "RDSAa.SIG", "RDSa.BN",
      "RDSA.PR", "RDSa.xt", "RDSAas.TRE", "RDSa.AS1", "RYDAF.PQ", "RDSa.TG",
    ...
    list(
      bestMatch = list(error = "No best match available"),
      error = "Unknown symbol", symbol = "NL0015476987"
    )
  )))

  Ex7Outcome <- list(list(mappedSymbols = list(
    list(RICs = c(
      "RDSa.AS", "RDSaEUR.xbo",
      "RDSaGBP.xbo", "RDSa.L", "RDSa.F", "RDSa.DE", "RDSAl.BS", "RDSAa.CHI",
      "RDSAa.BS", "RDSAl.CHI", "RDSa.BE", "RDSAa.TQ", "RDSAl.TQ", "RDSa.S",
    ...
    list(RICs = c(
      "AAPL.O", "AAPLEUR.xbo", "0R2V.L", "AAPL.OQ",
      ...
      "AAPL.B^J07"
    ), bestMatch = c(RIC = "AAPL.O"), symbol = "US0378331005")
  )))
  ...
  expect_equal(testEx3, structure(list(
    RICs = c(
      "RDSa.AS", "RDSaEUR.xbo", "RDSaGBP.xbo",
  ...
  expect_equal(testEx6, structure(
    list(
      RICs = c(
        "RDSa.AS", "RDSaEUR.xbo", "RDSaGBP.xbo",
        "RDSa.L", "RDSa.F", "RDSa.DE", "RDSAl.BS", "RDSAa.CHI", "RDSAa.BS",
      ...
      ISIN = c(
        "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29",
        "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29",
        "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29",
        "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29",
        "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29", "GB00B03MLX29",
  ...
  expect_equal(testEx7, structure(list(RICs = c(
    "RDSa.AS", "RDSaEUR.xbo", "RDSaGBP.xbo",
    "RDSa.L", "RDSa.F", "RDSa.DE", "RDSAl.BS", "RDSAa.CHI", "RDSAa.BS",
    "RDSAl.CHI", "RDSa.BE", "RDSAa.TQ", "RDSAl.TQ", "RDSa.S", "RDSa.MU",
    "RDSa.H", "RDSa.D", "RDSa.SG", "RYDAF.PK", "R6Cd.BS", "R6Cd.CHI",
    ...
    "US0378331005", "US0378331005", "US0378331005", "US0378331005",
    "US0378331005"
  )), row.names = c(NA, -198L), class = "data.frame"))
})
...
test_that("Eikon ProcessSymbology can convert \"Nan\" without converting the entire column to charachter", {
  ...
  CorrectOutcome <- structure(
    list(
      bestMatch = c("No best match available", "ticker2", "ticker2"),
...
test_that("Eikon PostProcessor can convert \"Nan\" without converting the entire column to charachter", {
  Input <- list(list(
    ...
    headers = list(list(
      ...
      list(
        displayName = "TR.COMPANYMARKETCAP(SDATE=0D,CURN=USD)/TR.FreeCashFlow(Period=LTM,SDate=0D,Curn=USD)/*Price to Free Cash Flow*/",
  ...
  GoodOutcome <- list(
    PostProcessedEikonGetData = structure(
      list(
        Instrument = c("0003.HK", "0005.HK", "0006.HK", "0008.HK"),
...
#####
# Q4: Tightened numeric coercion guard
#####

test_that("EikonPostProcessor does not coerce mixed-type columns to numeric", {
  input <- list(list(
    columnHeadersCount = 1L,
    data = list(
      list("AAPL.O", "123"),
    ...
    headers = list(list(
      list(displayName = "Instrument"),
      list(displayName = "Code")
    )),
    rowHeadersCount = 1L,
    totalColumnsCount = 2L,
    totalRowsCount = 3L
  ))
  result <- EikonPostProcessor(input)
  expect_type(result$PostProcessedEikonGetData$Code, "character")
  expect_equal(result$PostProcessedEikonGetData$Code, c("123", "ABC", "456"))
})


test_that("EikonPostProcessor converts pure numeric character columns", {
  input <- list(list(
    columnHeadersCount = 1L,
    data = list(
      list("AAPL.O", "100.5"),
  ...
  result <- EikonPostProcessor(input)
  expect_type(result$PostProcessedEikonGetData$Price, "double")
  expect_equal(result$PostProcessedEikonGetData$Price, c(100.5, 200.3))
})


test_that("EikonPostProcessor converts numeric columns that contain NAs", {
  input <- list(list(
    columnHeadersCount = 1L,
    data = list(
      list("AAPL.O", "100.5"),
  ...
  result <- EikonPostProcessor(input)
  expect_type(result$PostProcessedEikonGetData$Price, "double")
  expect_equal(result$PostProcessedEikonGetData$Price, c(100.5, NA, 300.1))
})


dump_refinitiv_options("test-eikonHelperfunctions")
