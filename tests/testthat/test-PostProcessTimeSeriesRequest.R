test_that("PostProcessTimeSeriesRequest works", {
  RawTimeSeries <- list(list(timeseriesData = list(list(
    dataPoints = list(
      list(180L, "2020-01-02T00:00:00Z"), list(178.45, "2020-01-03T00:00:00Z"),
  ...
  expected_outcome <- structure(
    list(
      Date = structure(c(1577923200, 1578009600, 1578268800, 1578355200, 1578441600, 1578528000, 1578614400),
...
test_that("PostProcessTimeSeriesRequest works with empty result", {
  expect_identical(
    PostProcessTimeSeriesRequest(RawTimeSeriesRequest = list(NA)),
...
test_that("PostProcessTimeSeriesRequest works with one wrong RIC", {
  RawTimeSeries <- list(list(timeseriesData = list(
    ...
    list(
      dataPoints = list(
        list("2020-07-22T00:00:00Z", 1899582L, 159.93, 157.02, 157.43, 158.71),
  ...
  expected_outcome <- structure(
    list(
      Date = structure(c(1595376000, 1595462400, 1595548800, 1595808000, 1595894400), class = c("POSIXct", "POSIXt"), tzone = "UTC"),
